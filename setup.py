...
DATA_FILES = [
	('/usr/bin',['bin/crushing-machine']),
	('/usr/share/nautilus-python/extensions',['src/crushingmachine.py']),
	('/usr/share/icons/gnome/256x256/actions',['data/icons/crushing-machine.png']),
	('/usr/share/applications',['data/crushing-machine.desktop'])
	]
